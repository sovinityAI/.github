...
2. Keep the Project **Status** and **Next actor** synchronized with reality.
3. Record decisions, blockers, handoffs, and verification evidence in GitHub.
4. Use **Needs input** when work pauses for a named decision or dependency.
5. Use **In review** when output exists but still needs verification.
6. Close an Issue only after its acceptance criteria are verified.
